...
public class ClosedStepConcurrentSimulationExecutor extends ConcurrentSimulationExecutor<ClosedStep> {
    ...
    private MavenTaskDto<ClosedStep> createTaskForQueryFile(String cubeName, String catalogName, File queryFile, String protocol, Map<String, String> connectionDetails) {
        try {
            ...
            String taskName = String.format("%s %s Concurrent User Simulation", cubeName, protocol.toUpperCase());
            ...
            // Set run description
            task.setRunDescription(String.format("%s %s Concurrent Cube Tests", cubeName, protocol.toUpperCase()));
            ...
            task.setRunId("ConcurrentRun-" + cubeName.replace(" ", "") + "-" + protocol);
            task.setRunLogFileName(cubeName.replace(" ", "_") + "_" + protocol + "_concurrent.log");
            ...
            logger.info("Created concurrent task for cube: " + cubeName + 
                       " (catalog: " + catalogName + ")" +
                       ", protocol: " + protocol + 
